...
fin_int_d_base   = 6;      // mm — internal fin radial depth (full depth for most of height)
fin_int_taper_z  = 10;     // mm — axial length of taper zone at top (depth fades 6mm→0 over this)
