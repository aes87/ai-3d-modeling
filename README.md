...
|--------|---------|:----:|-------------|-----|
| [P-touch Cradle](docs/ptouch-cradle.md) | ![Quiet desk dock for the Brother PT-P750W — low 25mm bathtub walls frame the printer base, removable label catch tray in front, Muji-Rams minimalism](docs/images/ptouch-cradle/cradle-user-front-in-use.png) | v4 | Quiet two-part desk dock for Brother PT-P750W. Symmetric 25mm bathtub cradle holds printer; removable tray catches auto-cut labels. No decoration — clean fillets, flush base, v3 minimalism. | [Cradle](designs/ptouch-cradle/output/cradle.stl) · [Tray](designs/ptouch-cradle/output/tray.stl) |
