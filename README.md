...
|--------|---------|:----:|-------------|-----|
| [Glitter Wizard Hat](docs/glitter-wizard-hat.md) | ![Conical wizard hat cap for vintage lava lamps with four rows of star, circle, and crescent moon cutouts](docs/images/glitter-wizard-hat/glitter-wizard-hat-iso.png) | v4.1 | Replacement cap for vintage Glitter Wizard lava lamps. Hollow cone with star/circle/crescent cutouts, retention lip for bottle neck fit. Two parametric sizes (95 mm / 114.3 mm). | [STL](designs/glitter-wizard-hat/output/glitter-wizard-hat.stl) |
