...
|--------|---------|:----:|-------------|-----|
| [P-touch Cradle](docs/ptouch-cradle.md) | ![Owl-themed two-part desktop cradle for Brother PT-P750W label printer — stepped body with full-perimeter bathtub walls, tall back panel with ear tufts, and removable catch tray with owl face embosses](docs/images/ptouch-cradle/cradle-iso.png) | v4 | Two-part owl-themed holder for Brother PT-P750W. Cradle holds the printer in a full-perimeter bathtub; removable tray catches auto-cut labels. Ear tufts peek above printer; owl face on tray front. | [Cradle](designs/ptouch-cradle/output/cradle.stl) · [Tray](designs/ptouch-cradle/output/tray.stl) |
