...
|--------|---------|:----:|-------------|-----|
| [Workout Dumbbell Holder](docs/workout-dumbbell-holder.md) | — | v4 (Fusion) | Clip-on holder for a vertical treadmill rail extrusion. Dual engagement — plug inside the rail, sleeve around the outside — with a horizontal slot through which the dumbbell shaft hangs vertically along the rail. Top + bottom r=22 buttresses, ribs along the fork bottom, sleeve −X wall removed for control-panel clearance. **First design routed to the Fusion 360 MCP backend.** 3 test prints planned. | [STL](designs/workout-dumbbell-holder/output/workout-dumbbell-holder.stl) · [F3D](designs/workout-dumbbell-holder/output/workout-dumbbell-holder.f3d) |
