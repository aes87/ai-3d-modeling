...
|--------|---------|:----:|-------------|-----|
| [P-touch Cradle](docs/ptouch-cradle.md) | ![Quiet desk dock for the Brother PT-P750W — low 25mm bathtub cradle with removable label catch tray, Muji-Rams minimalism](docs/images/ptouch-cradle/cradle-user-front-threequarter.png) | v4 | Quiet two-part desk dock for Brother PT-P750W. Symmetric 25mm bathtub cradle holds printer; removable tray catches auto-cut labels. No decoration — clean fillets, S-curve corner sweeps on the tray, top-edge fillet r=wall_t aligned across both parts. 2 test prints (tray-slot fit + printer-pocket U-fit). | [Cradle](designs/ptouch-cradle/output/cradle.stl) · [Tray](designs/ptouch-cradle/output/tray.stl) |
