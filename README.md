...
|--------|---------|:----:|-------------|-----|
| [P-touch Cradle](docs/ptouch-cradle.md) | ![Quiet desk dock for the Brother PT-P750W — low 25mm bathtub cradle with removable label catch tray, Muji-Rams minimalism](docs/images/ptouch-cradle/cradle-user-front-threequarter.png) | v4 | Quiet two-part desk dock for Brother PT-P750W. Symmetric 25mm bathtub cradle holds printer; removable tray catches auto-cut labels. No decoration — clean fillets, flush base, v3 minimalism. 1 test print for tray-slot fit. | [Cradle](designs/ptouch-cradle/output/cradle.stl) · [Tray](designs/ptouch-cradle/output/tray.stl) |
