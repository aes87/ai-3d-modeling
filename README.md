...
|--------|---------|:----:|-------------|-----|
| [P-touch Cradle](docs/ptouch-cradle.md) | ![Catch tray three-quarter view — S-curve side sweeps blend 30mm back walls down to 10mm uniform front wall, continuous top-edge fillet r=1.6mm matching the cradle's design proportion](docs/images/ptouch-cradle/tray-hero.png) | v4 | Quiet two-part desk dock for Brother PT-P750W. Symmetric 25mm bathtub cradle holds printer; removable tray catches auto-cut labels. No decoration — clean fillets, S-curve corner sweeps on the tray, top-edge fillet r=wall_t aligned across both parts. 2 test prints (tray-slot fit + printer-pocket U-fit). | [Cradle](designs/ptouch-cradle/output/cradle.stl) · [Tray](designs/ptouch-cradle/output/tray.stl) |
