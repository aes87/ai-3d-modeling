...
| Internal fins | 6×, 2mm thick, 6mm inward protrusion; taper to flush over top 10mm | Radial ribs protruding inward from bore wall; full depth for most of height, fade to bore wall in top 10mm |
...
volume:     158.8 cm³ (expected 80–300)     PASS
```
...
| Qty | Item | Notes |
|-----|------|-------|
| 1 | Duct mount (3D printed) | PLA, 158.8 cm³ |
